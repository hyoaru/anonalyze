...
class EmotionController:
    def __init__(self, emotion_classification_model: EmotionClassificationModelABC):
        self._emotion_classification_model: Any = emotion_classification_model
    ...
    def predict(self, text: str):
        ...
        prediction = self._emotion_classification_model.predict(preprocessed_text)
